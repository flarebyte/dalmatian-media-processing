...
describe('visual-path', () => {
  ...
  it('should provide toCoreSvgString', () => {
    const vpath = VPath.fromDalmatianString("[ M -1/7 -1/9,L 1/7 -1/9,Q 1/4 1/115 1/2 2/115,T 1/4 1/111,C 1/4 1/117 1/2 2/117 3/4 1/39,S 1/4 1/113 1/2 2/113,Z ]")
    expect(vpath.toCoreSvgString(100, 0)).toStrictEqual( "M -14.286 11.111 L 14.286 11.111 L 50.000 -1.739 L 25.000 -0.901 L 75.000 -2.564 L 50.000 -1.770 Z")
});
});
